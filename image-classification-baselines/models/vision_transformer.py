...
class Vit(nn.Module):
    def __init__(
        ...
        self.input_layer = VitInputLayer(in_channel, emb_dim, num_patch_row, image_size)
        self.encoder = nn.Sequential(*[VitEncoderBlock(emb_dim, head, hidden_dim, dropout) for _ in range(num_blocks)])
